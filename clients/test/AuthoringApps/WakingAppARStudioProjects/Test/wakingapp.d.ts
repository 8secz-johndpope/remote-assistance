...
declare var Texture: {
    prototype: WakingApp.Texture;
    new(Texture : WakingApp.Texture): WakingApp.Texture;
}

declare var Video: {
    prototype: WakingApp.Video;
    new(Texture : WakingApp.Video): WakingApp.Video;
}

declare var AudioClip: {
    prototype: WakingApp.AudioClip;
    new(Texture : WakingApp.AudioClip): WakingApp.AudioClip;
}

declare var WebRequest: {
    prototype: WakingApp.WebRequest;
    new(): WakingApp.WebRequest;
}
...
declare var Camera: {
     ...
     * @type {Transform}
     */
    readonly transform: WakingApp.Transform;
	 ...
	 * @returns {Vector3} 
	 */
	getIntersectionPointSLAM(): WakingApp.Vector3;
	 ...
	 * @returns {Vector3} 
	 */
	getIntersectionRotationSLAM(): WakingApp.Vector3;
}
/**
...
declare namespace WakingApp {
	...
	export interface Button {
         ...
         * @memberof Button
         */
        pressedTexture: WakingApp.Texture;
...
export interface WebRequest {
 ...
 export interface Vector2 {
    ...
    export interface MaterialBase {
         ...
         * @memberof MaterialBase
         */
        diffuseTexture: WakingApp.Texture;
    ...
    export interface PBRMaterial extends MaterialBase {
        ...
        roughnessMetallicTexture: WakingApp.Texture;

        /**
         * Holds the material emission texture texture property.
         * 
         * @type {Texture}
         * @memberof PBRMaterial
         */

        emissionTexture: WakingApp.Texture;  

        /**
        * Holds the material ambientOclussion texture texture property.
        * 
        * @type {Texture}
        * @memberof PBRMaterial
        */
       ambientOclussionTexture: WakingApp.Texture;
    }
