...
class ARSCNStereoViewClass : NSObject {
...
//        sceneViewRight.scene.background.contents = UIColor.clear
//        sceneViewRight.isHidden = true
//        sceneViewLeft.isHidden = true
...
//        let pixelBuffer : CVPixelBuffer? = sceneView.session.currentFrame?.capturedImage
        let pixelBuffer : CVPixelBuffer? = self.lastFrame?.capturedImage
        ...
        // FXPAL edit
        // This appears to be a key modification to the original code.
        // Otherwise, the camera frame isn't painted properly into the scene.
        // self.imageViewLeft.image = uiimage
        // self.imageViewRight.image = uiimage
        sceneViewLeft.scene.background.contents = uiimage
        sceneViewRight.scene.background.contents = uiimage
...
extension ARSCNStereoViewClass: ARSessionDelegate {
