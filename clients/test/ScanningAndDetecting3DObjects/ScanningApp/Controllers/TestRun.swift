...
class TestRun {
    ...
    func setReferenceObject(_ object: ARReferenceObject, screenshot: UIImage?) {
        ...
        // Add reference objects from library
        guard var referenceObjects = ARReferenceObject.referenceObjects(inGroupNamed: "ARObjects", bundle: nil) else {
            fatalError("Missing expected asset catalog resources.")
        }
        
        // Now load dynamic reference object
        referenceObjects.insert(object)
